class SubInstance < ActiveRecord::Base
  ...
  has_attached_file :top_banner, :styles => { :icon_full => "980x100#" }, :url => '/system/:class/:attachment/:id/:style/:filename'
  ...
  has_attached_file :menu_strip, :styles => { :icon_full => "5x50#" }, :url => '/system/:class/:attachment/:id/:style/:filename'
  ...
  has_attached_file :menu_strip_side, :styles => { :icon_full => "100x300#" }, :url => '/system/:class/:attachment/:id/:style/:filename'
